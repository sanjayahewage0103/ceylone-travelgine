  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-4">
        <img src="https://img.icons8.com/fluency/96/briefcase.png" alt="Vendor" className="mb-2" />
        <h2 className="text-3xl font-extrabold text-primary mb-1 tracking-tight">Vendor Login</h2>
