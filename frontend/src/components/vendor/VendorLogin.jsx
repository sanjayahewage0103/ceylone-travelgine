...
const VendorLogin = ({ onSwitchToRegister, onLogin, loading, error, success }) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-3 border border-white/20 bg-white/10 backdrop-blur-sm rounded-lg 
              text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent
      ...
      <div className="flex items-center">
        <input
          ...
          className="h-4 w-4 bg-white/10 border border-white/20 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
        />
      ...
      <div>
        <button
          ...
          className={`group relative w-full flex justify-center py-3 px-4 border border-transparent rounded-lg 
            text-white ${loading ? 'bg-purple-700' : 'bg-purple-600 hover:bg-purple-700'} 
            focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors
            font-medium text-lg shadow-lg shadow-purple-900/30 backdrop-blur-sm`}
        >
          {loading ? (
            <>
      ...
      <div className="text-center mt-4 text-sm text-white/70">
        <p>New to Ceylon Travelgine? <button type="button" onClick={onSwitchToRegister} className="text-purple-300 hover:text-purple-200 font-medium">Create an account</button></p>
      </div>
    </form>
  );
};
