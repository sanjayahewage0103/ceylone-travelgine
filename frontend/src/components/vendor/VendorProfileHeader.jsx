...
const VendorProfileHeader = ({ vendor, onEdit }) => (
  <div className="flex items-center gap-6 mb-8">
    <div className="relative">
      <img src={vendor.profileBanner || '/default-banner.jpg'} alt="Banner" className="w-[400px] h-32 object-cover rounded-lg" />
      ...
      <div className="absolute left-6 top-16">
        <img src={vendor.files?.logoUrl || '/default-profile.png'} alt="Profile" className="w-24 h-24 rounded-full border-4 border-white object-cover" />
