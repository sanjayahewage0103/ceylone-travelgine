...
const GuideLogin = ({ onSwitchToRegister, onLogin, error, success, loading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="text-center mt-4 text-sm text-white/70">
        <p>New to Ceylon Travelgine? <button type="button" onClick={onSwitchToRegister} className="text-teal-300 hover:text-teal-200 font-medium">Create an account</button></p>
      </div>
    </form>
  );
};
